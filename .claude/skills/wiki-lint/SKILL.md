...
This project-local skill is a compatibility wrapper for the marketplace `claude-obsidian` wiki-lint behavior. Use it whenever this project needs a reliable `/wiki-lint` entrypoint even if marketplace skill names are not exposed directly in the current session.
